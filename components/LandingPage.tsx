...
import { AppleIcon, ArrowUpIcon, BeanIcon, CodeIcon, FileIcon, FlaskRoundIcon, GitlabIcon, InfoIcon, LinkedinIcon, NotebookIcon, PackageIcon, PiIcon, SmartphoneIcon, SwatchBookIcon } from "lucide-react";
        ...
        <section id="about" className="mb-16">
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="mt-8 flex gap-4">
                  ...
                  <Link
                    href="https://drive.google.com/file/d/1zAdiC9Nh-hz0jl2Jg0NTxDUCekaOjr6N/view?usp=sharing"
                    target="_blank"
                    className="inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
                    prefetch={false}
                  >
        ...
        <section id="skills" className="mb-16">
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="mt-2 text-center">Swift</p>
            </div>
            <div className="flex flex-col items-center">
              <EclipseIcon className="h-12 w-12" />
            ...
            <div className="flex flex-col items-center">
              <CodepenIcon className="h-12 w-12" />
              <p className="mt-2 text-center">HTML/CSS</p>
            </div>
            <div className="flex flex-col items-center">
              <ArrowUpIcon className="h-12 w-12" />
              <p className="mt-2 text-center">Swift UI</p>
            </div>
            <div className="flex flex-col items-center">
              <PackageIcon className="h-12 w-12" />
              <p className="mt-2 text-center">UIKit</p>
            </div>
            <div className="flex flex-col items-center">
              <WindIcon className="h-12 w-12" />
              <p className="mt-2 text-center">Tailwind CSS</p>
            ...
            <div className="flex flex-col items-center">
              <SwatchBookIcon className="h-12 w-12" />
              <p className="mt-2 text-center">Swing</p>
            </div>
            <div className="flex flex-col items-center">
              <FlaskRoundIcon className="h-12 w-12" />
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="mt-2 text-center">Android Studio</p>
            </div>
            <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="mt-2 text-center">IntelliJ</p>
            </div>
            <div className="flex flex-col items-center">
              <EclipseIcon className="h-12 w-12" />
              <p className="mt-2 text-center">Eclipse</p>
            </div>
            <div className="flex flex-col items-center">
              <BeanIcon className="h-12 w-12" />
              <p className="mt-2 text-center">Netbeans</p>
            </div>
            <div className="flex flex-col items-center">
              <NotebookIcon className="h-12 w-12" />
              <p className="mt-2 text-center">Jupyter</p>
            </div>
            <div className="flex flex-col items-center">
              <CodeIcon className="h-12 w-12" />
              <p className="mt-2 text-center">XCode</p>
            </div>
            <div className="flex flex-col items-center">
              <CodepenIcon className="h-12 w-12" />
              <p className="mt-2 text-center">React</p>
            ...
            <div className="flex flex-col items-center">
              <DatabaseIcon className="h-12 w-12" />
              <p className="mt-2 text-center">Core Data</p>
            </div>
          </div>
        </section>
